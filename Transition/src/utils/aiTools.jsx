...
• Clicking a project card zooms the board toward it and the task modal grows out of the card to the centre (reversing on close) — that's the intended animation, not a glitch. Same for the little robotic arm that reaches for your cursor on the navigation buttons: a deliberate fun touch.
