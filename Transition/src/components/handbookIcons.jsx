/**
 * Lightweight inline SVG icon set for the Handbook builder. Keeps the handbook
 * self-contained (no icon dependency) and inherits `currentColor`.
 */
export function Icon({ name, size = 16, strokeWidth = 2 }) {
  ...
  switch (name) {
    ...
    case "heading":
      return (<svg {...p}><path d="M6 4v16M18 4v16M6 12h12" /></svg>);
    case "text":
    ...
    case "timeline":
      return (<svg {...p}><line x1="6" y1="3" x2="6" y2="21" /><circle cx="6" cy="7" r="2" /><circle cx="6" cy="17" r="2" /><line x1="10" y1="7" x2="20" y2="7" /><line x1="10" y1="17" x2="20" y2="17" /></svg>);
    case "steps":
    ...
    case "divider":
      return (<svg {...p}><line x1="3" y1="12" x2="21" y2="12" /></svg>);
    case "image":
    ...
    case "quote":
      return (<svg {...p}><path d="M3 21c3 0 7-1 7-8V5c0-1.25-.757-2.017-2-2H4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2s-1 .008-1 1.031V20c0 1 0 1 1 1z" /><path d="M15 21c3 0 7-1 7-8V5c0-1.25-.757-2.017-2-2h-4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2h.75c0 2.25.25 4-2.75 4v3c0 1 0 1 1 1z" /></svg>);
    case "check":
